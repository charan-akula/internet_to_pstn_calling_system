...
// // You should store your Deepgram API Key in your .env file in the client directory
// // e.g. VITE_DEEPGRAM_API_KEY=your_deepgram_api_key
// const DEEPGRAM_API_KEY = import.meta.env.VITE_DEEPGRAM_API_KEY || "53501965df075c62524dd784a906a65c85f8eecc";
...
//       // Give Livekit a moment to finish setting up the local audio track, then immediately start transcription
//       setTimeout(() => {
//         startRecording();
//       }, 500);
...
//     // 1. Setup Deepgram WebSocket
//     const deepgramUrl = 'wss://api.deepgram.com/v1/listen?diarize=true&punctuate=true&model=nova-2';

//     deepgramSocketRef.current = new WebSocket(deepgramUrl, [
//       'token',
//       DEEPGRAM_API_KEY,
//     ]);
...
//     deepgramSocketRef.current.onopen = () => {
//       console.log('Deepgram WebSocket connected');
//       // 2. Setup MediaRecorder for capturing stream and sending chunks
...
//       // Slice the audio every 250ms and emit dataavailable
//       mediaRecorderRef.current.start(250);
//       setIsRecording(true);
//     };
...
//             <div className="joinTitle">Join your calling room</div>
//             <div className="joinText">
//               Start a secure SIP call session and monitor who is speaking in real-time.
//             </div>
...
//                         Call
//                       </button>
//                       <button className="btn ghost small" onClick={() => hangUpPerson(p.id)}>
//                         {["calling", "answered", "active"].includes(p.status) ? "Hang Up" : "Remove"}
//                       </button>
//                       {["answered", "active"].includes(p.status) && (
//                         <button
...
//               </div>
//               <div>
//                 {isRecording && <span className="pill ok" style={{ backgroundColor: 'rgba(239, 68, 68, 0.1)', borderColor: 'rgb(239, 68, 68)', color: 'rgb(185, 28, 28)' }}>Recording</span>}
//               </div>
//             </div>
...
//               {transcripts.length === 0 && !audioUrl && (
//                 <div className="joinText" style={{ textAlign: "center", marginTop: 40 }}>
//                   No transcript yet. Join a call and hit Record Audio.
//                 </div>
//               )}
//               {transcripts.map(t => (
//                 <div key={t.id} className="transcriptMessage">
